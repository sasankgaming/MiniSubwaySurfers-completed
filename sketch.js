...
function setup(){
  ...
  background1.velocityY=0.7+score/300;
  background1.addImage(backgroundimage);

  //background1.addAnimation("track",backgroundimage);
  background1.scale=0.8;    

  GameOver=createSprite(200,300,100,40);
  GameOver.addImage(GameOverimage);
  GameOver.scale=0.6;
  GameOver.visible=false;

  Restart=createSprite(200,350,50,35);
...
function gold(){
  if(World.frameCount%210===0 ){
    ...
    goldCoin.velocityY=3+score/300;
...
function silver(){
  if(World.frameCount%150===0 ){
    ...
    silverCoin.velocityY=3+score/300;
...
function bronze(){
  if(World.frameCount%90===0 ){
    ...
    bronzeCoin.velocityY=3+score/300;
...
function mysteryBox1(){
  ...
  mysteryBox.velocityY=3+score/300;
...
function spawnobstacles(){
  if(World.frameCount%80===0){
    ...
    obstacles.velocityY=3+2*score/300;
